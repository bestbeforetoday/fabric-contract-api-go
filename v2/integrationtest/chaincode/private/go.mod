module github.com/hyperledger/fabric-chaincode-integration/chaincodeprivate
...
replace github.com/hyperledger/fabric-chaincode-go/v2 => ../../../../../fabric-chaincode-go/v2
